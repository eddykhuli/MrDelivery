...
app.controller('HomeController', ['$scope', 'store', "$window", "$http", function ($scope, store, $window, $http) {
       ...
       $http.get('/api/restaurant/restaurant/getAllRestaurants',config).then(function(response){
       ...
       {
            $scope.currentUser;
        $http.get('/api/person/account/person/getPerson/'+ $scope.loggedInAccount.userId, config).then(function (response) {
...
app.controller('Registration', ['$scope', '$http','$window', function ($scope, $http,$window) {
        ...
        $scope.onClick = function () {
                    ...
                    $http.post('/api/person/registerPerson', $scope.person, config).then(function () {
...
app.controller('RestaurantRequest', ['$scope', '$http','$window', function ($scope, $http,$window) {
        ...
        $scope.createRequest = function () {
            $http.post('/api/restaurantRequest/placeRequestForRestaurant', $scope.r, config).then(function () {
...
app.controller('DriverRequestController', ['$scope', '$http', '$location','$window', function ($scope, $http, $location,$window) {
        ...
        $scope.createDriverRequest = function (driver) {
            $http.post('/api/driver/registerDriver', $scope.driver, config).then(function (response) {
                console.log(response);
         ...
         $scope.viewToDeliverOrders = function(){
            ...
            $http.get('/api/orderInfo/driver/order/findByStatus/'+$scope.status,config).then(function(response){
                console.log(response.data);
        ...
        $scope.updateOrderStatus = function(order){
           ...
           $http.put('/api/orderInfo/restaurant/order/updateOrder/'+$scope.orderId,order,config).then(function(response){
...
app.controller('AdminController', ['$scope', '$http', '$window','store', function ($scope, $http, $window,store) {
       ...
       $scope.deleteUser = function(){
           $http.delete('/api/person/person/deletePerson/'+ store.get("userId"),config).then(function(response){
               alert("deleted");
           });
       };
        $scope.getPerson = function(){
             $http.get("/api/person/account/person/getPerson/" + store.get("userId"), config).then(function (response) {
            //$scope.userInfo = response.data;
            console.log(response.data);
        });
        };
       $scope.viewAllRestaurantRequests = function(){
            $http.get('/api/restaurantRequest/getAllRestaurantsRequests', config).then(function (response) {
            console.log(response);
            $scope.restaurants = response.data;
          ...
          $scope.allAccounts = function(){
            ...
            $http.get('/api/account/login/allAccounts',config).then(function(response){
                console.log(response);
                $scope.accounts = response.data;
            });
        };
          $scope.viewAllDriverRequests = function(){
            $http.get('/api/driver/getAllDriverRequests', config).then(function (response) {
            console.log(response);
            $scope.drivers = response.data;
        });
       };
       $scope.viewAllUsers = function(){
           $http.get('/api/person/person/getAllPeople',config).then(function(response){
               console.log(response);
        ...
        $scope.registerPartner = function (rests) {
                    ...
                    $http.post('/api/person/registerPartner', rests, config).then(function (response) {
                    console.log(response);
        ...
        $scope.registerDriver = function(driver){
            ...
            $http.post('/api/person/registerDriverAccount',driver,config).then(function(response){
                console.log(response);
        ...
        $scope.viewAllProducts = function(){
            ...
            $http.get('/api/product/restaurant/getAllProducts/',config).then(function(response){
        ...
        $scope.getAllOrders = function(){
            ...
            $http.get('/api/orderInfo/admin/order/allOrders',config).then(function(response){
                console.log(response);
...
app.controller('RestaurantController', ['$scope', '$http', '$window', 'store', function ($scope, $http, $window, store) {
        ...
        $http.get("/api/person/account/person/getPerson/" + id, config).then(function (response) {
            //$scope.userInfo = response.data;
            console.log(response.data);
        });
        ...
        $scope.addRestaurant = function ()
        {
            ...
            $http.post('/api/restaurant/restaurant/addRestaurant',restaurant,config).then(function (response) {
        ...
        $http.get('/api/restaurant/restaurant/getByAccountId/'+store.get("accountObj").id,config).then(function(response){
            console.log(response.data);
        ...
        $scope.addCategory = function(){
            ...
            var categoryInfo = {
             ...
             $http.post('/api/category/categories/addCategory/'+store.get("restObj").id,categoryInfo,config).then(function (response) {
                console.log(response.data);
       ...
       console.log(store.get("restObj").id);
         ...
         $scope.addProduct = function () {
            ...
            console.log(catName);
              ...
              var price =  parseFloat($scope.price);
                   ...
                   $http.post('/api/product/restaurant/addProduct/'+catName,productInfo, config).then(function (response) {
                        console.log(response);
        ...
        $scope.viewRestOrders = function(){
            ...
            $http.get('/api/orderInfo/restaurant/getOrders/'+$scope.restaurantName,config).then(function(response){
                console.log(response.data);
                $scope.orders = response.data;
                $scope.orderDate = $scope.orders.orderDate;
            });
...
app.controller('MenuController', ['$scope', '$http','store','$window','$rootScope', function ($scope, $http,store,$window,$rootScope) {
       ...
       $http.get('/api/restaurant/restaurant/getByAccountId/'+ store.get("restaurant").accountId,config).then(function(response){
           console.log(response.data);
           ...
           $http.get('/api/category/categories/get/getCategoryByRestId/'+store.get("restaurant").accountId,config).then(function(response){
                console.log(response.data);
        ...
        console.log(orderInfo);
                ...
                $scope.toCardPayment = function(){
                 ...
                 $scope.placeOrder = function(){
                           ...
                           $http.post('/api/orderInfo/order/saveOrder',$scope.orderInfo).then(function(response){
...
//                               console.log(store.get("orderObj"));
                            ...
                            $http.post('/api/payment/order/payment',paymentInfo,config).then(function(response){
                                alert("payment made");
                                console.log(response.data);
                              ...
                              $scope.done = function(){
                                  ...
                                  'userId' : store.get("orderObj").userId,
                                   'status' : "Payed",
                                    ...
                                    console.log(paymentInfo);
                                         $http.post('/api/orderInfo/order/payment',paymentInfo,config).then(function(response){
                                        alert("payment made");
                                       console.log(response.data);
                                   });
