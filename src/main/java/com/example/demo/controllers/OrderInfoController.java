...
@Api(value = "OrderInfoControllerApi" , produces = MediaType.APPLICATION_JSON_VALUE)
public class OrderInfoController {
    ...
    @RequestMapping(value = "/order/saveOrder", method = RequestMethod.POST,consumes="application/json")
