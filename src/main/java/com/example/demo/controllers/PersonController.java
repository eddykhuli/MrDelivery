...
public class PersonController {
    ...
    @ApiOperation("It adds the creates a person object and also an account object for that person")
    ...
    public Person updateProfile(@PathVariable @Valid long id,@RequestBody @Valid Person person)
    {
        Person updatedPerson = service.updateCustomer(id, person);
